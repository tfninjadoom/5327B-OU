...
// pros::Rotation rotation1(ROTATION_PORTS[0]);   pros::Rotation rotation2(ROTATION_PORTS[1]);   pros::Rotation rotation3(ROTATION_PORTS[2]);
...
// pros::ADIDigitalOut double-acting